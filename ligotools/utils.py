...
def plt_matched(time,timemax,SNR,pcolor,det,eventname,plottype):
    # -- Plot the result
...
def plt_whiten(time,tevent,strain_whitenbp,pcolor,det,template_match,timemax,eventname,plottype):
    plt.figure(figsize=(10,8))
    plt.subplot(2,1,1)
...
def plt_ASD(fs,template_fft,datafreq,d_eff,freqs,data_psd,pcolor,det,eventname,plottype):
