...
from ligotools.utils import whiten as whiten
from ligotools.utils import write_wavfile as write_wavfile
from ligotools.utils import reqshift as reqshift
from ligotools.utils import plt_matched as plt_matched
from ligotools.utils import plt_whiten as plt_whiten
from ligotools.utils import plt_ASD as plt_ASD
...
for det in dets:
    ...
    if make_plots:
        ...
        #plotting with util functions    
        plt_matched(time,timemax,SNR,pcolor,det,eventname,plottype)
        plt_whiten(time,tevent,strain_whitenbp,pcolor,det,template_match,timemax,eventname,plottype)
        plt_ASD(fs,template_fft,datafreq,d_eff,freqs,data_psd,pcolor,det,eventname,plottype)  
